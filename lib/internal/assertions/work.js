...
module.exports = function __assertWork (callback) {
  var self = this
  ...
  self.__assert('connection', function (connection) {
    connection.createChannel(function (err, channel) {
      ...
      channel.on('error', function (err) {
        console.error('Work channel died, probably because routing response back to a requester failed. Recreating.', err)
