...
function Remit (o) {
    ...
    this._service_name = o.name || ''
    this._url = o.url || 'amqp://localhost'
    this._exchange_name = o.exchange || 'remit'
    this._lazy = !!o.lazy
...
// Remit.prototype.listen = require('./external/request/listen')
...
Remit.prototype.__send_data = require('./internal/send/data')
