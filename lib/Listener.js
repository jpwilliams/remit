...
class Listener {
  ...
  async _incoming (message) {
    ...
    message.properties.headers.crumbs.push(`${message.properties.messageId} ${this._remit._options.name} LISTENER RECV ${this._options.event} :: ${this._remit._fingerprint}`)
