...
class Endpoint {
  ...
  async _incoming (message) {
    ...
    message.properties.headers.crumbs.push(`${message.properties.messageId} ${this._remit._options.name} REQUEST RECV ${this._options.event} :: ${this._remit._fingerprint}`)
    ns.set('crumbs', message.properties.headers.crumbs)
    ...
    if (!canReply) {
      ...
      message.properties.headers.crumbs = ns.get('crumbs')
      message.properties.headers.crumbs.push(`${message.properties.messageId} ${this._remit._options.name} RESPONSE SENT ${this._options.event} :: ${this._remit._fingerprint}`)
